...
if __name__=="__main__":
    ...
    for k_moins_un,name in [(k,f"data/history_kNN_{k}_N_{N}_0") for k in ks]:
        ...
        comparaison(content_random, content_imgep, name = [f"image/comp_ratios_{k_moins_un}",f"image/comp_times_k{k_moins_un}"])
        comparaison2(content_random, content_imgep, name = f"comp_ratios_iteration_{k_moins_un}", k = k_moins_un + 1)
